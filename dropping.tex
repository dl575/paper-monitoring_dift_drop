...
Otherwise, on the commit
of instruction types relevant to the specific monitor, the needed address and
register information is forwarded to the monitor automatically.
...
possible instruction type (load, store, etc.).
