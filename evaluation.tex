...
200 million instructions each using 2 main cores to run the benchmark application.
...
assuming that errors/attacks are uniformly distributed across checks. While
this is not necessarily true for actual errors/attacks, we believe this metric
...
number of short, independent monitoring dependence chains.
