...
array bounds check as we vary the overhead budget. The bottom portion of each
...
Since only array allocations, which are infrequent, are considered as source events for BC, it is
